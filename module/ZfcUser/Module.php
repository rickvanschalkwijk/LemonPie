    ...
    public function getServiceConfig()
    {
        return array(
            ...
            'factories' => array(
                ...
                'zfcuser_edit_profile_form' => function($sm) {
                    $options = $sm->get('zfcuser_module_options');
                    $form = new Form\EditProfile(null, $sm->get('zfcuser_module_options'));
                    $form->setInputFilter(new Form\EditProfileFilter( $options ));
                    return $form;
                },
